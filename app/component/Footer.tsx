...
const Footer: React.FC = () => {
    return (
      <footer className="bg-gradient-to-r from-[#FFC2C7] to-[#8FDDE7] text-white">
        <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex items-center  p-1 bg-gradient-to-r from-[#FFC2C7] via-[#FBE5C8] to-[#B6E5D8] rounded-full shadow-md">
                <img
  ...
  */}
    ...
    <div>
      ...
      <ul className="mt-6 space-y-4 text-sm">
        <li>
          <a href="#" className="text-gray-700 transition hover:opacity-75">New Arrivals</a>
        </li>
        <li>
          <a href="#" className="text-gray-700 transition hover:opacity-75">Best Sellers</a>
        </li>
        <li>
          <a href="#" className="text-gray-700 transition hover:opacity-75">Genres</a>
        </li>
        <li>
          <a href="#" className="text-gray-700 transition hover:opacity-75">Gift Cards</a>
        </li>
        <li>
          <a href="#" className="text-gray-700 transition hover:opacity-75">Special Offers</a>
        </li>
      </ul>
    </div>
